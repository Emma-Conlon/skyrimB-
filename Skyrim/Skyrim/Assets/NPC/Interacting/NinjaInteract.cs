...
public class NinjaInteract : MonoBehaviour
{
    ...
    IEnumerator NpcInteractActive()
    {
        ...
        Npc_Name.GetComponent<Text>().text = "Ninja Nona";
        Npc_Name.SetActive(true);
        Npc_Text.GetComponent<Text>().text = "Just Resting before i leave to the dungeon";
