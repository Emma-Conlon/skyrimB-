...
UNITY_INSTANCING_BUFFER_END(Terrain)
      ...
      #endif
      {
         ...
         #if !_MICROMESHTERRAIN && !_TERRAINBLENDABLESHADER && !_MICROMESH && !_MICRODIGGERMESH && !_MICROVERTEXMESH && defined(UNITY_INSTANCING_ENABLED) && !defined(SHADER_API_D3D11_9X)
...
ENDCG
   ...
   Dependency "BaseMapShader" = "Hidden/MicroSplat/Terrain_Base-782711749"
